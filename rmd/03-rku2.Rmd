...
```{r}
# matriks plot
GGally::ggpairs(as.data.frame(rku$pc.score), title = "Matriks Korelasi antar Komponen Utama")
...
Dari output di atas diketahui bahwa dua komponen utama pertama (PC1 dan PC2), mewakili keragaman sekitar 80,9%. Hasil regresi memiliki *R-Square* = 0.88, menunjukkan bahwa persamaan regresi relatif baik.
